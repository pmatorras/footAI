...
def execute(countries, seasons, divisions, args, dirs):    
    ...
    if args.multi_countries:
        ...
        with log_training_run(countries, divisions, args.features_set, seasons, args.model, multidiv=args.multi_division, multicountry=True, tier=args.tier, tune=args.tune) as json_path:   
        ...
        for country in countries:
            ...
            if args.multi_division:  
                ...
                with log_training_run(country, divisions[country], args.features_set, seasons, args.model, multidiv=True, tune=args.tune) as json_path:   
                ...
                for division in divisions[country]:
                    ...
                    with log_training_run(country, division, args.features_set, seasons, args.model, tune=args.tune) as json_path:
                ...
                for season in seasons:
                    ...
                    for division in divisions[country]:
                        ...
                        with log_training_run(country, [division], args.features_set, [season], tune=args.tune) as json_path:
                            # Train baseline model
