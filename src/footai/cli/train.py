    ...
    if args.multi_division:  
        ...
        for division in divisions:
            ...
            with log_training_run(args.country, division, args.features_set, seasons, args.model) as json_path:
                ...
                print("="*70)
                write_metrics_json(json_path, args.country, [division], args.features_set, results, seasons)
        ...
        for season in seasons:
            ...
            for division in divisions:
                ...
                with log_training_run(args.country, [division], args.features_set, [season]) as json_path:
                    # Train baseline model
